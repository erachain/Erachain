...
public class TransactionRef_BlockRef_Map extends DCMap<byte[], byte[]> 
{
	private Map<Integer, Integer> observableData = new HashMap<Integer, Integer>();
	
	//private BlockMap blockMap;
	
	public TransactionRef_BlockRef_Map(DCSet databaseSet, DB database)
	{
		super(databaseSet, database);
	}

	public TransactionRef_BlockRef_Map(TransactionRef_BlockRef_Map parent, DCSet dcSet) 
	{
		super(parent, dcSet);
	...
	public Block getParent(byte[] txSignature)
	{
		...
		return getDCSet().getBlockMap().get(bs);
	}
