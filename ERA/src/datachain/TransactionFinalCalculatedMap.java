...
//import core.transaction.Calculated;
import database.DBMap;
import database.serializer.CalculatedSerializer;
...
public class TransactionFinalCalculatedMap extends DCMap<Tuple3<Integer, Integer, Long>, Calculated> {
    ...
    @Override
    protected Map<Tuple3<Integer, Integer, Long>, Calculated> getMap(DB database) {
        // OPEN MAP
        return openMap(database);
    }

    @Override
    protected Map<Tuple3<Integer, Integer, Long>, Calculated> getMemoryMap() {
