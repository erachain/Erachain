...
public class tt extends JPanel { // implements TreeSelectionListener {
	...
	public tt() {
		...
		DefaultMutableTreeNode linked_hashes_Node = new DefaultMutableTreeNode(
				Lang.getInstance().translate("Linked Hashes"));
		DefaultMutableTreeNode records_Node = new DefaultMutableTreeNode(Lang.getInstance().translate("Records"));
		DefaultMutableTreeNode other_Node = new DefaultMutableTreeNode(
				Lang.getInstance().translate("Network DashBoard"));
		...
		// templates_Node.add(new
		// DefaultMutableTreeNode(Lang.getInstance().translate("My
		// Templates")));
