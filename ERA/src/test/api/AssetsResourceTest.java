...
public class AssetsResourceTest extends SettingTests {
    ...
    public void getAseetsLite() throws Exception {
        ...
        String resultRemote = CallRemoteApi.ResponseCodeAPI
                (SettingTests.URL_LOCAL_NODE_RPC + "/assets", "GET");
        switch (resultRemote) {
            case "0":
    ...
    public void getAssetsFull() throws Exception {
        ...
        String resultRemote = CallRemoteApi.ResponseCodeAPI
                (SettingTests.URL_LOCAL_NODE_RPC + "/assets/full", "GET");
        switch (resultRemote) {
            case "0":
                fail("Remote EraChain node is not run");
                break;
        ...
        String resultAssetFull = CallRemoteApi.ResponseValueAPI(SettingTests.URL_LOCAL_NODE_RPC + "/assets/full", "GET", "");
