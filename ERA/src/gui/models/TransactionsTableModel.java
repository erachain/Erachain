...
public class TransactionsTableModel extends TableModelCls<byte[], Transaction> implements Observer {
    ...
    public void setBlockNumber(String string) {
        ...
        // byte[] block_key = DBSet.getInstance().getBlockHeightsMap().getBySignature(Long.parseLong(string));
        // Block block = DBSet.getInstance().getBlocksHeadMap().getBySignature(block_key);
