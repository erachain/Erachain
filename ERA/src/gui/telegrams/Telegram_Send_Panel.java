...
public class Telegram_Send_Panel extends AssetSendPanel {
    
    private Telegram_Send_Panel th;
    public boolean noRecive;
    
    public Telegram_Send_Panel(AssetCls asset, Account account, Account account_To, PersonCls person) {
