...
public class VotingDetailPanel extends JPanel{

	private VotingTabPane votingTabPane;
	private JComboBox<ItemCls> cbxAssets;
	
	public VotingDetailPanel(Poll poll, AssetCls asset) 
	{
		//CREATE FRAME
	//	super(Lang.getInstance().translate("Erachain.org") + " - " + Lang.getInstance().translate("Poll Details"));
	...
	//	assetLabelGBC.weighty=0.1;
		...
		cbxAssets.addActionListener (new ActionListener () {
		    public void actionPerformed(ActionEvent e) {
		    	...
		    	if(asset != null)
		    	{
		    		votingTabPane.setAsset(asset);
		    	}
		    }
		});
		
		//POLL TABPANE
        this.votingTabPane = new VotingTabPane(poll, asset);
	/*	
		//ON CLOSE
	...
	*/	       
        ...
        this.add(this.votingTabPane, pollTabPaneGBC);
