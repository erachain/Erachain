	...
	public Echange_Sell_Buy_Panel(AssetCls have2, AssetCls want2, String action2, String account2) {
		...
		trades.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Tuple3<Long, BigDecimal, BigDecimal>, Tuple2<Long, BigDecimal>> order = sellOrdersTableModel.getOrder(row);
		...
		cancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Tuple3<Tuple5<BigInteger, String, Long, Boolean, BigDecimal>,
				Tuple3<Long, BigDecimal, BigDecimal>, Tuple2<Long, BigDecimal>> order = sellOrdersTableModel.getOrder(row1);
		...
		sellOrdersTable.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Tuple3<Long, BigDecimal, BigDecimal>, Tuple2<Long, BigDecimal>>> rowObj = sellOrdersTableModel.orders.get(row);
				if (rowObj == null)
					return;
				Tuple3<Tuple5<BigInteger, String, Long, Boolean, BigDecimal>,
				Tuple3<Long, BigDecimal, BigDecimal>, Tuple2<Long, BigDecimal>> order = rowObj.getB();
				if (order == null)
					return;
				...
				if (e.getClickCount() == 2) {
					...
					if(row < sellOrdersTableModel.orders.size())
					{
						buyOrderPanel.txtAmount.setText(order.b.b.toPlainString());
		...
		buyOrdersTable.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Pair<BigInteger, Tuple3<Tuple5<BigInteger, String, Long, Boolean, BigDecimal>,
				Tuple3<Long, BigDecimal, BigDecimal>, Tuple2<Long, BigDecimal>>> rowObj = buyOrdersTableModel.orders.get(row);
				if (rowObj == null)
					return;
				Tuple3<Tuple5<BigInteger, String, Long, Boolean, BigDecimal>,
				Tuple3<Long, BigDecimal, BigDecimal>, Tuple2<Long, BigDecimal>> order = rowObj.getB();
				...
				if (e.getClickCount() == 2) {
					//if (buying)
					sellOrderPanel.txtAmount.setText(buyOrdersTableModel.orders.get(row).getB().b.b.toPlainString());
					sellOrderPanel.txtPrice.setText(buyOrdersTableModel.orders.get(row).getB().a.e.toPlainString());
				}
			}
		});
		// MENU on MY ORDERS
		...
		buyTrades.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Tuple3<Long, BigDecimal, BigDecimal>, Tuple2<Long, BigDecimal>>> sl = buyOrdersTableModel.getSortableList();
				if (sl.isEmpty())
					return;
				...
				Tuple3<Tuple5<BigInteger, String, Long, Boolean, BigDecimal>,
				Tuple3<Long, BigDecimal, BigDecimal>, Tuple2<Long, BigDecimal>> order = buyOrdersTableModel.getOrder(row);
				if(order != null)
					new TradesFrame(order);
			}
		});
		...
		tradesTable.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Tuple3<Tuple5<BigInteger, String, Long, Boolean, BigDecimal>, Tuple3<Long, BigDecimal, BigDecimal>, Tuple2<Long, BigDecimal>> initiator = Order.getOrder(db, trade.a);
				...
				if (e.getClickCount() == 2) {
					...
					if (type) {
						...
						sellOrderPanel.txtAmount.setText(trade.c.toPlainString());
						sellOrderPanel.txtPrice.setText(price.toPlainString());

						buyOrderPanel.txtAmount.setText(trade.d.toPlainString());
