...
public class IssueAssetPanel1 extends JPanel
{
	...
	public void onIssueClick()
	{
		...
		try
		{
			...
			IssueAssetTransaction issueAssetTransaction = (IssueAssetTransaction)Controller.getInstance().issueAsset(creator, this.txtName.getText(), this.txtareaDescription.getText(), null, null,
			...
			text += Lang.getInstance().translate("Asset Type") +":&nbsp;"+ Lang.getInstance().translate(((AssetCls)issueAssetTransaction.getItem()).getAssetType()+"")+ "<br>";
