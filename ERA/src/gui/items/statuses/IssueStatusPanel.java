...
public class IssueStatusPanel extends JPanel {
	...
	public IssueStatusPanel() {
		...
		// Lang.getInstance().translate("Issue Status"));
		...
		/*
		 * //ICON List<Image> icons = new ArrayList<Image>();
		 ...
		 * icons.add(Toolkit.getDefaultToolkit().getImage(
		 * "images/icons/icon128.png")); this.setIconImages(icons);
		 */
	...
	public void onIssueClick() {
		...
		byte[] image = null;
		// CREATE ASSET
		// PrivateKeyAccount creator, String fullName, int feePow, long
		// birthday,
