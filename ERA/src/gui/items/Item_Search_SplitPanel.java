...
public class Item_Search_SplitPanel extends Split_Panel{
	...
	private TableModelItems search_Table_Model;
	protected MTable search_Table;
...
// для прозрачности
	...
	protected int row;
	public Item_Search_SplitPanel(TableModelItems search_Table_Model, String gui_Name, String search_Label_Text){
		
		super(gui_Name);
		this.search_Table_Model = search_Table_Model;
...
//CHECKBOX FOR FAVORITE	
		TableColumn favorite_Column = search_Table.getColumnModel().getColumn(search_Table_Model.COLUMN_FAVORITE);//.COLUMN_KEY);//.COLUMN_CONFIRMED);
		...
		search_Table.addMouseMotionListener(new MouseMotionListener() {
		    public void mouseMoved(MouseEvent e) {
		        ...
		        if(search_Table.columnAtPoint(e.getPoint())==search_Table_Model.COLUMN_FAVORITE)
		        {
					...
					if(e.getClickCount() == 1 & e.getButton() == e.BUTTON1)
					{
						...
						if (jTable_jScrollPanel_LeftPanel.getSelectedColumn() == search_Table_Model.COLUMN_FAVORITE){
							row = jTable_jScrollPanel_LeftPanel.convertRowIndexToModel(row);
							 ItemCls asset = search_Table_Model.getItem(row);
		...
		favorite.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
    	    	...
    	    	vsend_Coins_Item.addActionListener(new ActionListener(){
    	  		@Override
    	    	public void actionPerformed(ActionEvent e) {
    	  			Object person = search_Table_Model.getItem(row);
    	  			Account_Send_Dialog fm = new Account_Send_Dialog(null,null,null, (PersonCls) person);				
    				}});
    	    	...
    	    	send_Mail_Item.addActionListener(new ActionListener(){
    	  		@Override
    	    	public void actionPerformed(ActionEvent e) {
    	  		ItemCls person = search_Table_Model.getItem(row);
    	  				Mail_Send_Dialog fm = new Mail_Send_Dialog(null,null,null, (PersonCls) person);
    				}});
...
// listener select row	 
	 class search_listener implements ListSelectionListener  {
			...
			public void valueChanged(ListSelectionEvent arg0) {
				ItemCls item = null;
				if (search_Table.getSelectedRow() >= 0 ) item = search_Table_Model.getItem(search_Table.convertRowIndexToModel(search_Table.getSelectedRow()));
				if (item == null) return;
