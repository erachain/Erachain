...
public class AccountingTransactionV3 extends AccountingTransaction {
	...
	public AccountingTransactionV3(PublicKeyAccount creator, Account recipient, long key, BigDecimal amount, BigDecimal fee, byte[] data, byte[] isText, byte[] encrypted, long timestamp, byte[] reference, byte[] signature) {
	...
	public static Transaction Parse(byte[] data) throws Exception
	{
		...
		return new AccountingTransactionV3(creator, recipient, key, amount, fee, arbitraryData, isTextByte, encryptedByte, timestamp, reference, signatureBytes);
