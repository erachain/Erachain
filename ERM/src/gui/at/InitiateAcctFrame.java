...
public class InitiateAcctFrame extends JFrame {
	...
	{
		super(Lang.getInstance().translate("ARONICLE.world") + " - " + Lang.getInstance().translate("Initiate ACCT"));
	...
	public void onDeployClick()
	{
		...
		try
		{
			...
			String name = "ARONICLE.worldBURST @ " + quantity.divide(burstQuantity, 2, RoundingMode.HALF_UP);
