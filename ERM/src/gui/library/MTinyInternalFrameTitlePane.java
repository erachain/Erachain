 ...
 * @author Hans Bickel
 */
public class MTinyInternalFrameTitlePane extends BasicInternalFrameTitlePane
	implements LayoutManager
{
	 ...
	 */
	public MTinyInternalFrameTitlePane(JInternalFrame frame) {
		super(frame);
	}
...
//		item.setMnemonic('S');
	...
	public void paintComponent(Graphics g) {
		...
		//setPreferredSize(new Dimension(500,UIManager.getFont("Button.font").getSize()*2));
		...
		if(frameTitle != null) {
			...
			int yOffset = ((height - fm.getHeight()) / 1) + fm.getAscent() + 1;
			if(!leftToRight)
				xOffset -= titleLength;
