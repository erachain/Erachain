...
import de.muntjak.tinylookandfeel.borders.TinyInternalFrameBorder;
	 ...
	 * @author Hans Bickel
	 */
	public class MTyniInternalFrameUI extends BasicInternalFrameUI {
		 ...
		 */
		private MTinyInternalFrameTitlePane titlePane;
		 ...
		 */
		public MTyniInternalFrameUI(JInternalFrame frame) {
			super(frame);
		}
		...
		public static ComponentUI createUI(JComponent c) {
			return new MTyniInternalFrameUI((JInternalFrame) c);
		}
		...
		protected JComponent createNorthPane(JInternalFrame frame) {
			...
			titlePane = new MTinyInternalFrameTitlePane(frame);
			...
			extends InternalFramePropertyChangeListener
		{
			public void propertyChange(PropertyChangeEvent evt) {
	            ...
	            MTyniInternalFrameUI ui = (MTyniInternalFrameUI)f.getUI();
