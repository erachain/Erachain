...
public class RegisterNameDetailsFrame extends JFrame
{
	public RegisterNameDetailsFrame(RegisterNameTransaction nameRegistration)
	{
		...
		//TYPE
		detailGBC.gridy = 0;
		JLabel type = new JLabel(Lang.getInstance().translate("Register Name Transaction"));
		...
		//SIGNATURE
		detailGBC.gridy = 1;
		JTextField signature = new JTextField(Base58.encode(nameRegistration.getSignature()));
		...
		//REFERENCE
		detailGBC.gridy = 2;
		JTextField reference = new JTextField(Base58.encode(nameRegistration.getReference()));
		...
		//TIMESTAMP
		detailGBC.gridy = 3;
		JTextField timestamp = new JTextField(DateTimeFormat.timestamptoString(nameRegistration.getTimestamp()));
		...
		//REGISTRANT
		detailGBC.gridy = 4;
		JTextField registrant = new JTextField(nameRegistration.getCreator().getAddress());
		...
		//FEE
		detailGBC.gridy = 9;
		JTextField fee = new JTextField(nameRegistration.getFee().toPlainString());
		...
		//CONFIRMATIONS
		detailGBC.gridy = 10;
		JLabel confirmations = new JLabel(String.valueOf(nameRegistration.getConfirmations()));
