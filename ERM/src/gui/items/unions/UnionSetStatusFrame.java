...
public class UnionSetStatusFrame extends JFrame  {

	private JComboBox<Account> accountLBox;
	private JComboBox<StatusCls> statusLBox;

	public UnionSetStatusFrame(JComponent  apers, UnionCls union) {
		super();
			...
			JTextField pubKey1Txt, JTextField pubKey2Txt, JTextField pubKey3Txt, JTextField toDateTxt, JTextField feePowTxt)
	{
		...
		//Controller.getInstance().r_SertifyPerson(version, false, authenticator,
		//		feePow, union.getKey(), 
