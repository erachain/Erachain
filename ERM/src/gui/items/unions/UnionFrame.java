...
public class UnionFrame extends JFrame
{
	private UnionCls union;
	
	public UnionFrame(UnionCls union)
	{
		...
		//DETAILS
		tabPane.add(Lang.getInstance().translate("Details"), new UnionDetailsPanel(this.union));
		
		//BALANCES
		BalancesTableModel balancesTableModel = new BalancesTableModel(union.getKey());
