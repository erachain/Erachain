...
public class Statements_Table_Model extends JTable implements Observer{
	...
	public Statements_Table_Model()
	{
		...
		copyMessage.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e) 
			{
		        ...
		        Statements_Table_Model invokerAsJComponent = (Statements_Table_Model) invoker;
        ...
        this.addMouseListener(new MouseAdapter() 
			{
				public void mouseClicked(MouseEvent e) 
				{
					...
					{
						Statements_Table_Model tableModelparent = (Statements_Table_Model) e.getSource();
...
//		System.out.println("44444:   "+message.getType());
	...
	//		System.out.println(message.getType());
				...
				
			{
				...
				if(!is)
				{
					addMessage(0, (R_SignNote) message.getValue());
	...
	private void addMessage(int pos, R_SignNote transaction)
	{
	...
	public class MessageBuf
	{
		...
		public MessageBuf( byte[] rawMessage, boolean encrypted, String sender, long timestamp, BigDecimal amount, long assetKey, BigDecimal fee, byte[] signature, byte[] senderPublicKey, boolean isText )
		{
