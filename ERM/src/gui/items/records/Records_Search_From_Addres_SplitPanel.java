...
import lang.Lang;
	...
	public class Records_Search_From_Addres_SplitPanel extends Split_Panel{
	
		TransactionsTableModel transactionsTableModel;
		JScrollPane jScrollPane4;

		    public Records_Search_From_Addres_SplitPanel() {
		   
		    	
		    	jScrollPane4 = new  JScrollPane();
		    	
		    	this.setName(Lang.getInstance().translate("Search Records from Address"));
		    	
		    	this.searthLabel_SearchToolBar_LeftPanel.setText(Lang.getInstance().translate("Insert Address")+":");
