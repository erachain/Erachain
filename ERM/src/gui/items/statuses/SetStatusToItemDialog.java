...
//public class StatusConfirm extends JDialog { // InternalFrame  {
public class SetStatusToItemDialog extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public SetStatusToItemDialog(JComponent  apers, StatusCls status) {
		super();
...
this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
	...
	public void onGoClick(
			StatusCls status, JButton Button_Confirm,
			Account creator, ItemCls item,
	 ...
	 */
	    ...
	    private void initComponents(StatusCls status) {
	        java.awt.GridBagConstraints gridBagConstraints;

	        jLabel_StatusInfo = new javax.swing.JScrollPane();
	        ...
	        jLabel_StatusInfo.setBorder(javax.swing.BorderFactory.createEtchedBorder());
	        Status_Info info = new Status_Info(); 
	        info.show_001(status);
	        info.setFocusable(false);
	        jLabel_StatusInfo.setViewportView( info);
	   //     jLabel_StatusInfo.setText(new Status_Info().Get_HTML_Status_Info_001(status) );
	        ...
	        getContentPane().add(jLabel_StatusInfo, gridBagConstraints);
	        ...
	        jButton_SetStatus.addActionListener(new java.awt.event.ActionListener() {
	            public void actionPerformed(java.awt.event.ActionEvent evt) {
	            	onGoClick(status, jButton_SetStatus, (Account)jComboBox_YourAddress.getSelectedItem(),
	        ...
	        getContentPane().add(new javax.swing.JLabel(Lang.getInstance().translate("Information about the status")+":"),
	        		gridBagConstraints);
	    ...
	    private javax.swing.JScrollPane jLabel_StatusInfo;
