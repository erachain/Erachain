...
public class AllStatusesPanel extends JPanel {
	...
	private TableModelStatuses tableModelStatuses;
	

	public AllStatusesPanel() {
		...
		TableColumn divisibleColumn = statusesTable.getColumnModel().getColumn(StatusesTableModel.COLUMN_DIVISIBLE);
		...
		*/
		...
		statusesTable.setComponentPopupMenu(nameSalesMenu);
		...
		this.add(new JScrollPane(statusesTable), tableGBC);
