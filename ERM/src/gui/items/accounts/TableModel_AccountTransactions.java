...
public class TableModel_AccountTransactions extends DefaultTableModel implements Observer {
	...
	private SortableList_Account_Transaction<Tuple2<String, String>, Transaction> transactions;
	...
	static Logger LOGGER = Logger.getLogger(TableModel_AccountTransactions.class.getName());

	public TableModel_AccountTransactions()
	{
	...
	public synchronized void syncUpdate(Observable o, Object arg)
	{
		...
		if(message.getType() == ObserverMessage.LIST_TRANSACTION_TYPE)
		{
			if(this.transactions == null)
			{
				this.transactions = (SortableList_Account_Transaction<Tuple2<String, String>, Transaction>) message.getValue();
