...
public class other_Panel extends javax.swing.JPanel {
    ...
    // all block table
		...
		this.jTable_All_Block = new JTable(this.All_Blocks_TableModel);
         ...
         this.jTable_All_Block.setDefaultRenderer(Tuple2.class, new Renderer_Left()); // set renderer
...
Map<Integer, Integer> indexes = new TreeMap<Integer, Integer>();
		...
		jTable_My_Block.setRowSorter(sorter);
         ...
         this.jTable_My_Block.setDefaultRenderer(String.class, new Renderer_Left()); // set renderer
         this.jTable_My_Block.setDefaultRenderer(Tuple2.class, new Renderer_Left()); // set renderer
