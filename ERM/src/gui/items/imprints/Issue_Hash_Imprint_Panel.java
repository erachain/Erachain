...
public class Issue_Hash_Imprint_Panel extends JPanel
{
	...
	public Issue_Hash_Imprint_Panel()
	{
...
//		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
	...
	//	((JComponent) this.getContentPane()).setBorder(new EmptyBorder(5, 5, 5, 5));
		...
		txtGBC.fill = GridBagConstraints.BOTH;//.HORIZONTAL;  
		...
		//GridBagConstraints txtAria = txtGBC;
		txtGBC.weightx = 1.0;
		txtGBC.weighty = 1.0;
