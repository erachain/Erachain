...
public class PersonFrame extends JFrame
{
	...
	public PersonFrame(PersonCls person)
	{
		...
		//DETAILS
		tabPane.add(Lang.getInstance().translate("Details"), new PersonDetailsPanel(this.person));
		
		//BALANCES
		BalancesTableModel balancesTableModel = new BalancesTableModel(person.getKey());
