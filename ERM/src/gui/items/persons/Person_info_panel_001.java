...
public class Person_info_panel_001 extends javax.swing.JPanel {
    ...
    private void initComponents(PersonCls person, boolean full) {
        ...
        jTable1.setDefaultRenderer(String.class, new Renderer_Left(jTable1.getFontMetrics(jTable1.getFont()))); // set renderer
     ...
     // GET CERTIFIED ACCOUNTS
        ...
        jTable2.setDefaultRenderer(String.class, new Renderer_Left(jTable2.getFontMetrics(jTable2.getFont()))); // set renderer
      //CHECKBOX FOR FAVORITE
