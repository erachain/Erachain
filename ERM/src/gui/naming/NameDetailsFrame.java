...
public class NameDetailsFrame extends JFrame
{
	...
	{
		super(Lang.getInstance().translate("ARONICLE.world") + " - " + Lang.getInstance().translate("Name Details"));
		...
		//REGISTRANT
		detailGBC.gridy = 1;
		JTextField registrant = new JTextField(name.getOwner().getPersonAsString());
