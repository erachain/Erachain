...
public class Regex {
    ...
    public static final Pattern VALID_MENTION_UTF8;
    ...
    public static final Pattern INVALID_MENTION_MATCH_END_UTF8;
    /**
    ...
    static {
        synchronized (Regex.class) {
            ...
            VALID_MENTION_UTF8 = Pattern.compile("(^|[^&" + HASHTAG_LETTERS_NUMERALS + "])(@|\uFF20)(?!\uFE0F|\u20E3)(" + HASHTAG_LETTERS_NUMERALS_SET + "*" + HASHTAG_LETTERS_SET + HASHTAG_LETTERS_NUMERALS_SET + "*)", Pattern.CASE_INSENSITIVE);
            INVALID_MENTION_MATCH_END_UTF8 = Pattern.compile("^(?:[@\uFF20]|://)");
