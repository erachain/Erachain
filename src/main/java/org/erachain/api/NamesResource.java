...
public class NamesResource {
    ...
    public String getNames(String address, boolean values) {
        ...
        if (account == null) {
            ...
            for (Transaction transaction : DCSet.getInstance().getTransactionFinalMap().getTransactionsByAddressAndType(address, Transaction.REGISTER_NAME_TRANSACTION, 0)) {
            ...
            for (Transaction transaction : DCSet.getInstance().getTransactionFinalMap().getTransactionsByAddressAndType(address, Transaction.UPDATE_NAME_TRANSACTION, 0)) {
            ...
            for (Transaction transaction : DCSet.getInstance().getTransactionFinalMap().getTransactionsByAddressAndType(address, Transaction.BUY_NAME_TRANSACTION, 0)) {
