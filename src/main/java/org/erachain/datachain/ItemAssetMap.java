...
import static org.erachain.core.item.assets.AssetTypes.AS_ACCOUNTING;
            ...
            switch (key.intValue()) {
                ...
                case (int) AssetCls.LIA_KEY:
                    item = new AssetVenture((byte) 0, appData, GenesisBlock.CREATOR, AssetCls.LIA_NAME, null, null,
                            AssetCls.LIA_DESCR, AS_ACCOUNTING, 0, 0L);
                    item = null;

                    break;
                case 555:
                    item = new AssetVenture((byte) 0, appData, GenesisBlock.CREATOR, new String("¤¤¤"), null, null,
                            "Businessman", AS_ACCOUNTING, 8, 0L);
                    break;
                case 666:
                    item = new AssetVenture((byte) 0, appData, GenesisBlock.CREATOR, new String("♠♠♠"), null, null, // ♠♠♠
                            "bad, angry", AS_ACCOUNTING, 8, 0L);
                    break;
                case 777:
                    item = new AssetVenture((byte) 0, appData, GenesisBlock.CREATOR, new String("♥♥♥"), null, null,
                            "Good Shine", AS_ACCOUNTING, 8, 0L);
                    break;
                case 643:
                    item = new AssetVenture((byte) 0, appData, GenesisBlock.CREATOR, new String("RUB"), null, null,
                            "Accounting currency by ISO 4217 standard", AS_ACCOUNTING, 2, 0L);
                    break;
                case 840:
