...
public class Network extends Observable {
    ...
    private static final int MAX_HANDLED_TELEGRAM_MESSAGES_SIZE = 1024 << (3 + BlockChain.HARD_WORK);
    private static final int MAX_HANDLED_TRANSACTION_MESSAGES_SIZE = 1024 << (1 + BlockChain.HARD_WORK >> 1);
    private static final int MAX_HANDLED_WIN_BLOCK_MESSAGES_SIZE = 128 >> (BlockChain.HARD_WORK >> 1);
