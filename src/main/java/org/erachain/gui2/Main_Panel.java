...
import org.erachain.gui.Wallets.Wallets_Manager_SplitPanel;
import org.erachain.gui.bank.Issue_Send_Payment_Order;
import org.erachain.gui.bank.My_Order_Pauments_SplitPanel;
import org.erachain.gui.items.accounts.Accounts_Name_Search_SplitPanel;
import org.erachain.gui.items.accounts.My_Accounts_SplitPanel;
import org.erachain.gui.items.accounts.My_Loans_SplitPanel;
import org.erachain.gui.items.assets.*;
import org.erachain.gui.items.imprints.Imprints_Favorite_SplitPanel;
import org.erachain.gui.items.imprints.Imprints_Search_SplitPanel;
import org.erachain.gui.items.imprints.IssueImprintPanel;
import org.erachain.gui.items.imprints.My_Imprints_Tab;
import org.erachain.gui.items.link_hashes.Issue_Linked_Hash_Panel;
import org.erachain.gui.items.link_hashes.Search_Linked_Hash;
import org.erachain.gui.items.mails.Incoming_Mails_SplitPanel;
import org.erachain.gui.items.mails.Mail_Send_Panel;
import org.erachain.gui.items.mails.Outcoming_Mails_SplitPanel;
import org.erachain.gui.items.other.Other_Console_Panel;
import org.erachain.gui.items.other.Other_Search_Blocks;
