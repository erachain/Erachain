...
public class IssuePersonsUnionPanel extends IssueItemPanel implements RecipientAddress.RecipientAddressInterface {
    ...
    protected void makeTransaction() {
        ...
        PersonsUnion union = new PersonsUnion(itemAppData, creator, textName.getText(),
                birthday, deathday, 0, null, birthLatitude, birthLongitude,
                null, null, null, 0,
                addIconLabel, addImageLabel, textAreaDescription.getText());
        transaction = (IssuePersonsUnionPanel) Controller.getInstance().issuePersonUnion(itemAppData, creator, exLink, feePow
                union);
    }
