...
public class AccountRepayDebtDialog extends JDialog {
    ...
    public AccountRepayDebtDialog(AssetCls asset, Account account) {
        ...
        AccountRepayDebtPanel panel = new AccountRepayDebtPanel(asset, account, null,null);
