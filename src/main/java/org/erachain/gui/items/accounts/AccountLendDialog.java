...
public class AccountLendDialog extends JDialog {
    ...
    public AccountLendDialog(AssetCls asset, Account account) {
        //ICON
        ...
        AccountLendPanel panel = new AccountLendPanel(asset, account, null,null);
