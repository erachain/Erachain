...
public class IncomingMailsPanel extends JPanel // implements ItemListener
...
//		this.add(cbxFavorites, favoritesGBC);
        ...
        table = new MailsTransactionsTable(true);
        ...
        // render
        //	table.setDefaultRenderer(Long.class, new RendererRight()); // set renderer
        //	table.setDefaultRenderer(String.class, new RendererLeft(table.getFontMetrics(table.getFont()), tableModel.getColumnAutoHeight())); // set renderer
		...
		sendAsset.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				//Menu.selectOrAdd( new AccountSendDialog(asset, account), null);
				 ...
				 new MailSendDialog(asset, account);
