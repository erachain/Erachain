...
public class OutcomingMailsPanel extends JPanel // implements ItemListener
...
// JInternalFrame
{
    ...
    public OutcomingMailsPanel() {
        ...
        table = new MailsTransactionsTable(false);
        ...
        // render
        // table.setDefaultRenderer(Long.class, new RendererRight()); // set
        // renderer
        // table.setDefaultRenderer(String.class, new
        // RendererLeft(table.getFontMetrics(table.getFont()),
         ...
         * AccountSendDialog(asset, account), null);
         *
