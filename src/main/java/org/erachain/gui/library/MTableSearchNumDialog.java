 ...
 * @author Саша
 */
public class MTableSearchNumDialog extends javax.swing.JDialog {

    Class class_1;
    /**
     * Creates new form MTableSearchNumDialog
     *
     * @param class1
     * @param column
     * @param Second_IF_Txt
    ...
    public MTableSearchNumDialog(TableColumn column, Class class1, ComparisonType first_IF_Com, String first_IF_Txt, ComparisonType second_IF_Com, String second_IF_Txt) {
        super();
