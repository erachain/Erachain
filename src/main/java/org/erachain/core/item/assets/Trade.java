...
public class Trade {
    ...
    public void process_old(DCSet db) {
        ...
        initiator.getCreator().changeBalance(db, false, false, initiator.getWantAssetKey(), this.amountHave, false);
        ...
        target.getCreator().changeBalance(db, false, false, target.getWantAssetKey(), this.amountWant, false);
    }
    ...
    public void orphan_old(DCSet db) {
        ...
        initiator.getCreator().changeBalance(db, true, false, initiator.getWantAssetKey(), this.amountHave, false);
        ...
        target.getCreator().changeBalance(db, true, false, target.getWantAssetKey(), this.amountWant, false);
