...
public abstract class ImprintCls extends ItemCls {
    ...
    public ImprintCls(byte[] typeBytes, long flags, PublicKeyAccount owner, String name, byte[] icon, byte[] image, String description) {
        super(typeBytes, flags, owner, name, icon, image, description);

    }

    public ImprintCls(int type, long flags, PublicKeyAccount owner, String name, byte[] icon, byte[] image, String description) {
