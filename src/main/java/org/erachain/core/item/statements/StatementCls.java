...
public abstract class StatementCls extends ItemCls {
    ...
    public StatementCls(byte[] typeBytes, long[] flags, PublicKeyAccount maker, String name, byte[] icon, byte[] image, String description) {
        super(typeBytes, flags, maker, name, icon, image, description);
    }

    public StatementCls(int type, long[] flags, PublicKeyAccount maker, String name, byte[] icon, byte[] image, String description) {
