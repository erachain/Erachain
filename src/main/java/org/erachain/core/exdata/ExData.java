    ...
    public void process(Transaction transaction, Block block) {
        ...
        if (template != null) {
            ...
            if (royaltyFee != null && royaltyFee.signum() != 0) {
                ...
                templateOwner.changeCOMPUBonusBalances(dcSet, false, royaltyFee, Account.FEE_BALANCE_SIDE_EARNED);
    ...
    public void orphan(Transaction transaction) {
        ...
        if (template != null) {
            ...
            if (royaltyFee != null && royaltyFee.signum() != 0) {
                ...
                // учтем что получили бонусы
                templateOwner.changeCOMPUBonusBalances(dcSet, true, royaltyFee, Account.FEE_BALANCE_SIDE_EARNED);
            }
