...
public class RSertifyPubKeys extends Transaction implements Itemable {
    ...
    public void process(Block block, int forDeal) {
        ...
        if (!personalized) {
            ...
            GenesisBlock.CREATOR.changeBalance(dcSet, true, false, AssetCls.LIA_KEY, BigDecimal.ONE, false, true);
            ...
            if (personBonus.signum() != 0) {
                pkAccount.changeBalance(dcSet, false, false, FEE_KEY, personBonus, false, false);
            ...
            BlockChain.FEE_ASSET_EMITTER.changeBalance(dcSet, true, false, FEE_KEY, issued_FEE_BD_total, false, true);
    ...
    public void orphan(Block block, int forDeal) {
        ...
        if (!personalized) {
            ...
            // SUBSTRACT from EMISSION (with minus)
            GenesisBlock.CREATOR.changeBalance(dcSet, false, false, AssetCls.LIA_KEY, BigDecimal.ONE, false, true);
            ...
            if (personBonus.signum() != 0) {
                ...
                pkAccount.changeBalance(dcSet, true, false, FEE_KEY, personBonus, false, false);
            ...
            BlockChain.FEE_ASSET_EMITTER.changeBalance(dcSet, false, false, FEE_KEY, issued_FEE_BD_total, false, true);
