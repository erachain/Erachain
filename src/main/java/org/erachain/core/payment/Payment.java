...
public class Payment {
    ...
    public void process(PublicKeyAccount sender, DCSet db) {
        ...
        sender.changeBalance(db, true, this.asset, this.amount, true, false);

        //UPDATE RECIPIENT
        //this.recipient.setBalance(this.asset, this.recipient.getBalance(db, this.asset).add(this.amount), db);
        this.recipient.changeBalance(db, false, this.asset, this.amount, false, false);
    }
    ...
    public void orphan(PublicKeyAccount sender, DCSet db) {
        ...
        sender.changeBalance(db, false, this.asset, this.amount, true, false);

        //UPDATE RECIPIENT
        //this.recipient.setBalance(this.asset, this.recipient.getBalance(db, this.asset).subtract(this.amount), db);
        this.recipient.changeBalance(db, true, this.asset, this.amount, false, false);
    }
}
