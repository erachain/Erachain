...
public final class Fun {
     ...
     * This is useful companion to {@link Bind#mapInverse(org.mapdb.Bind.MapWithModificationListener, Set)}
     * and {@link Bind#secondaryKey(org.mapdb.Bind.MapWithModificationListener, Set, org.mapdb.Fun.Function2)}
    ...
    public static <K2,K1> Iterable<K1> filter(final NavigableSet<Tuple2<K2, K1>> secondaryKeys,
        ...
        return new Iterable<K1>(){
            ...
            public Iterator<K1> iterator() {
                ...
                final Iterator<Tuple2<K2,K1>> iter =
    ...
    public static <A,B,C> Iterable<C> filter(final NavigableSet<Tuple3<A, B, C>> secondaryKeys,
                                             final A a, final B b) {
        return new Iterable<C>(){
            @Override
            public Iterator<C> iterator() {
                //use range query to get all values
                final Iterator<Tuple3> iter =
                        ((NavigableSet)secondaryKeys) //cast is workaround for generics
                                .subSet(
