    ...
    public void testOrderProcessingDivisible2() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                Assert.assertEquals(0, trade.getInitiator() == (order_BA_1_ID));
                Assert.assertEquals(0, trade.getTarget() == (order_AB_1_ID));
                Assert.assertEquals(0, trade.getAmountHave() == (BigDecimal.valueOf(100)));
                ...
                Assert.assertEquals(0, trade.getInitiator() == (order_AB_2_ID));
                Assert.assertEquals(0, trade.getTarget() == (order_BA_1_ID));
    ...
    public void testOrderProcessingMultipleOrders() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                accountB.changeBalance(dcSet, false, false, FEE_KEY, BigDecimal.valueOf(1).setScale(assetA.getScale()), false, false, false, false);
    ...
    public void testOrderProcessingForks() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                accountB.changeBalance(dcSet, false, false, FEE_KEY, BigDecimal.valueOf(1), false, false, false, false);
    ...
    public void validateCancelOrderTransaction() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                // CHECK IF CANCEL ORDER IS INVALID
                accountA.changeBalance(fork, true, false, FEE_KEY, new BigDecimal("1000"), false, false, false, false);
