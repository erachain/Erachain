    ...
    public void validateCreateOrderTransaction() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                orderCreation.sign(accountA, Transaction.FOR_NETWORK);
                orderCreation.setDC(dcSet, Transaction.FOR_NETWORK, BlockChain.ALL_BALANCES_OK_TO + 1, ++seqNo);
    ...
    public void testOrderProcessingDivisible() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                // ACCOUNT
                // B
                Assert.assertEquals(accountA.getBalanceUSE(keyB, dcSet), BigDecimal.valueOf(120)); // BALANCE
                // B
                // FOR
                // ACCOUNT
                // A
                ...
                Assert.assertEquals(0, order_BA_1.getInitiatedTrades(dcSet).get(1).getInitiator().compareTo(order_BA_1_ID));
    ...
    public void testOrderProcessing_065period() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                orderCreation.sign(accountA, Transaction.FOR_NETWORK);
                orderCreation.setDC(dcSet, Transaction.FOR_NETWORK, 1, ++seqNo);
                orderCreation.process(null, Transaction.FOR_NETWORK);
                ...
                // CHECK BALANCES
                Assert.assertEquals(accountA.getBalanceUSE(keyA, dcSet), new BigDecimal("49970.00000000")); // BALANCE
                Assert.assertEquals(accountA.getBalanceUSE(keyB, dcSet), new BigDecimal("0.00000333")); // BALANCE

                Assert.assertEquals(accountB.getBalanceUSE(keyB, dcSet), new BigDecimal("49999.99999667")); // BALANCE
                Assert.assertEquals(accountB.getBalanceUSE(keyA, dcSet), new BigDecimal("0.001")); // BALANCE
    ...
    public void testOrderProcessingDivisible2() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                // ACCOUNT
                // A
                Assert.assertEquals(accountA.getBalanceUSE(keyB, dcSet), BigDecimal.valueOf(1000)); // BALANCE
                // B
                // FOR
                // ACCOUNT
                // A
                ...
                // ACCOUNT
                // B
                Assert.assertEquals(accountB.getBalanceUSE(keyA, dcSet), BigDecimal.valueOf(100)); // BALANCE
                // A
                // FOR
                // ACCOUNT
                // B
                ...
                // ACCOUNT
                // B
                assertEquals(accountA.getBalanceUSE(keyB, dcSet), bal_A_keyB.add(order_BA_2_wantTaked)); // BALANCE
                // B
                // FOR
                // ACCOUNT
                // A
    ...
    public void testOrderProcessingWantDivisible() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                // ACCOUNT
                // B
                Assert.assertEquals(accountA.getBalanceUSE(keyB, dcSet), BigDecimal.valueOf(99.9)); // BALANCE
                // B
                // FOR
                // ACCOUNT
                // A
                Assert.assertEquals(accountB.getBalanceUSE(keyA, dcSet), BigDecimal.valueOf(999)); // BALANCE
                // A
                // FOR
                // ACCOUNT
                // B
    ...
    public void testOrderProcessingHaveDivisible_3() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                issueAssetTransaction.setDC(dcSet, Transaction.FOR_NETWORK, 2, 1);
                issueAssetTransaction.process(null, Transaction.FOR_NETWORK);
                ...
                orderCreation.sign(accountA, Transaction.FOR_NETWORK);
                orderCreation.setDC(dcSet, Transaction.FOR_NETWORK, 2, 2);
                assertEquals(Transaction.VALIDATE_OK, orderCreation.isValid(Transaction.FOR_NETWORK, flags));
                orderCreation.process(null, Transaction.FOR_NETWORK);
                Long orderID_B = orderCreation.makeOrder().getId();
                ...
                orderCreation.sign(accountA, Transaction.FOR_NETWORK);
                orderCreation.setDC(dcSet, Transaction.FOR_NETWORK, 2, 3);
                assertEquals(Transaction.VALIDATE_OK, orderCreation.isValid(Transaction.FOR_NETWORK, flags));
                orderCreation.process(null, Transaction.FOR_NETWORK);
                Long orderID_A = orderCreation.makeOrder().getId();
                ...
                // CHECK BALANCES
                Assert.assertEquals(accountA.getBalanceUSE(keyA, dcSet), BigDecimal.valueOf(93).setScale(BlockChain.AMOUNT_DEDAULT_SCALE)); // BALANCE
                // A
                // FOR
                // ACCOUNT
                // A
                // 60000 - 5000 returned by auto cancel
                Assert.assertEquals(accountB.getBalanceUSE(keyB, dcSet), BigDecimal.valueOf(1000000 - 60000).setScale(BlockChain.AMOUNT_DEDAULT_SCALE)); // BALANCE
                // B
                // FOR
                // ACCOUNT
                // B
                Assert.assertEquals(accountA.getBalanceUSE(keyB, dcSet), BigDecimal.valueOf(60000).setScale(BlockChain.AMOUNT_DEDAULT_SCALE)); // BALANCE
                // B
                // FOR
                // ACCOUNT
                // A
                Assert.assertEquals(accountB.getBalanceUSE(keyA, dcSet), BigDecimal.valueOf(3.2).setScale(BlockChain.AMOUNT_DEDAULT_SCALE)); // BALANCE
                // A
                // FOR
                // ACCOUNT
                // B
    ...
    public void testOrderProcessingHaveDivisible_3point() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                // ACCOUNT
                // B
                Assert.assertEquals(accountA.getBalanceUSE(keyB, dcSet), BigDecimal.valueOf(60003)); // BALANCE
                // B
                // FOR
                // ACCOUNT
                // A
                ...
                // ACCOUNT
                // A
                Assert.assertEquals(accountB.getBalanceUSE(keyB, dcSet), BigDecimal.valueOf(918998.955)); // BALANCE
                // B
                // FOR
                // ACCOUNT
                // B
                Assert.assertEquals(accountA.getBalanceUSE(keyB, dcSet), BigDecimal.valueOf(55001.21)); // BALANCE
                // B
                // FOR
                // ACCOUNT
                // A
                ...
                // CHECK ORDERS
                /// order in memory !!!
                Order orderE = dcSet.getOrderMap().get(orderID_E);
                Assert.assertEquals(false, dcSet.getCompletedOrderMap().contains(orderE.getId()));
                ...
                Order order_123 = dcSet.getOrderMap().getOrdersForTrade(keyB, keyA, false).get(0);
                assertEquals(1, dcSet.getOrderMap().getOrdersForTrade(keyB, keyA, false).size());
    ...
    public void testOrderProcessingMultipleOrders() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                accountB.changeBalance(dcSet, false, FEE_KEY, BigDecimal.valueOf(1).setScale(assetA.getScale()), false);
    ...
    public void testOrderProcessingForks() {
        ...
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                accountB.changeBalance(dcSet, false, FEE_KEY, BigDecimal.valueOf(1), false);
