...
public class TestRecStatus {
    ...
    public void validateSignatureIssueStatusTransaction() {
        ...
        //CREATE STATUS
        Status status = new Status(itemFlags, maker, "test", icon, image, "strontje", true);
...
//TODO actualize the test
    ...
    public void parseIssueStatusTransaction() {
        ...
        StatusCls status = new Status(itemFlags, maker, "test132", icon, image, "12345678910strontje", true);
    ...
    public void process_orphanIssueStatusTransaction() {
        ...
        StatusCls status_2 = new Status(itemFlags, maker, "test132_2", icon, image, "2_12345678910strontje", true);
