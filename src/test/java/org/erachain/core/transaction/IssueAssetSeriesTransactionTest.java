...
public class IssueAssetSeriesTransactionTest {
    ...
    public void parse() {
        ...
        //CREATE UPDATE ORDER
        IssueAssetSeriesTransaction tx = new IssueAssetSeriesTransaction(maker, null, new byte[64], (AssetVenture) assetMovable, FEE_POWER, timestamp, 0L);
    ...
    public void process() {
        for (int dbs : TESTED_DBS) {
            ...
            try {
                ...
                //CREATE SERIES
                final IssueAssetSeriesTransaction createOrderTX = new IssueAssetSeriesTransaction(maker, null, new byte[64], (AssetVenture) assetMovable, FEE_POWER, timestamp, 0L);
