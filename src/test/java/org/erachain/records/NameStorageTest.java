...
public class NameStorageTest {
    ...
    public void setup() {
        ...
        sender.changeBalance(databaseSet, false, false, FEE_KEY, BigDecimal.valueOf(1), false, false);
        ...
        //		, NTP.getTime());
        //transaction.process(databaseSet, false);
        buyer.changeBalance(databaseSet, false, false, FEE_KEY, BigDecimal.valueOf(1), false, false);
