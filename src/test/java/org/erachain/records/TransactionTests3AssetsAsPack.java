...
public class TransactionTests3AssetsAsPack {
    ...
    public void validateCancelOrderTransaction() {
        ...
        createOrderTransaction.setDC(db, Transaction.FOR_NETWORK, 1, 1);
        ...
        cancelOrderTransaction.setDC(db, Transaction.FOR_NETWORK, 1, 1);
        ...
        maker.changeBalance(fork, false, FEE_KEY, BigDecimal.ZERO, false, false);
    ...
    public void validateMessageTransaction() {
        ...
        creator.changeBalance(db, false, key, BigDecimal.valueOf(100).setScale(BlockChain.AMOUNT_DEDAULT_SCALE), false, false);
