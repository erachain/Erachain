...
public class TransactionTests3AssetsAsPack {
    ...
    public void validateCancelOrderTransaction() {
        ...
        maker.changeBalance(fork, false, false, FEE_KEY, BigDecimal.ZERO, false);
    ...
    public void validateMessageTransaction() {
        ...
        creator.changeBalance(db, false, false, key, BigDecimal.valueOf(100).setScale(BlockChain.AMOUNT_DEDAULT_SCALE), false);
